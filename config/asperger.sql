...
('Mon espace de travail idéal serait', 4, 0, 1, 3, 5, null, null, null, null, 'dans un bureau seul, sans aucun visiteur pendant la journée.', 'dans un bureau seul, avec un visiteur occasionnel pendant la journée.', 'dans un bureau avec un ou deux autres.', 'dans un bureau à aire ouverte.', '', '', '', ''),
